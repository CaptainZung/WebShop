...
function Head(){
    const {data, qtyWL} = useContext(UserContext)
    ...
    if(user){
      ...
      return <li onClick={logIn}><a ><i className="fa fa-lock" /> Login</a></li>
    }
              ...
              <div className="col-md-8 clearfix">
                <div className="shop-menu clearfix pull-right">
                  <ul className="nav navbar-nav">
                    ...
                    <li><a href><i className="fa fa-star" /> Wishlist {"("+qtyWL+")"}</a></li>
                    <li><a href="checkout.html"><i className="fa fa-crosshairs" /> Checkout</a></li>
                    <li><Link to="/product/cart"><i className="fa fa-shopping-cart" /> Cart  {"("+data+")"}</Link></li>
                    {checkLogin()}
                  </ul>
                </div>
              </div>
